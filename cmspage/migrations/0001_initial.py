            ...
            fields=[
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        [
                            ("hero", cmspage.blocks.HeroImageBlock(label="Hero Image", max_num=1)),
                            (
                                "title",
                                wagtail.blocks.StructBlock(
                                    [
                                        (
                                            "text",
                                            wagtail.blocks.CharBlock(help_text="Title text to display", required=True),
                                        )
                                    ],
                                    label="Title",
                                    max_num=1,
                                                    ...
                                                    [
                                                        ...
                                                        (
                                                            ...
                                                            wagtail.images.blocks.ImageChooserBlock(
                                                                help_text="Image - auto-cropped 570x370px",
                                                                required=False,
                                                            ),
                                                        ),
                                                        (
                                                            ...
                                                            wagtail.blocks.StructBlock(
                                                                ...
                                                                help_text="Enter a link or select a page/document",
                                                                required=False,
                                                            ),
                                                        ),
                                                    ]
                            ...
                            (
                                ...
                                wagtail.blocks.StructBlock(
                                    [
                                        ("image", wagtail.images.blocks.ImageChooserBlock(blank=True, null=True)),
                                        (
                                            "image_alignment",
                            ...
                            ("large_image", cmspage.blocks.LargeImageBlock()),
                            ("table", cmspage.blocks.CustomTableBlock()),
                            ("carousel", wagtail.blocks.StructBlock([])),
                            ("new_section", cmspage.blocks.NewSectionBlock()),
                        ],
                        blank=True,
                        null=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_object",
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="cmspage_tags", to="cmspage.cmspage"
                    ),
                ),
                (
                    "tag",
