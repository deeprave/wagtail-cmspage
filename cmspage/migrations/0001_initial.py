...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('wagtailcore', '0097_alter_redirect_unique_together_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.fields.StreamField([('hero', 0), ('title', 2), ('cards', 13), ('image_and_text', 20), ('cta', 23), ('richtext', 26), ('video', 28), ('large_image', 29), ('table', 30), ('carousel', 31), ('new_section', 32)], blank=True, block_lookup={0: ('cmspage.blocks.HeroImageBlock', (), {'label': 'Hero Image', 'max_num': 1}), 1: ('wagtail.blocks.CharBlock', (), {'help_text': 'Title text to display', 'required': True}), 2: ('wagtail.blocks.StructBlock', [[('text', 1)]], {'label': 'Title', 'max_num': 1}), 3: ('wagtail.blocks.CharBlock', (), {'blank': True, 'help_text': 'Bold title text for this card (len=255)', 'max_length': 255, 'null': True, 'required': False}), 4: ('wagtail.blocks.RichTextBlock', (), {'blank': True, 'help_text': 'Optional text for this card', 'null': True, 'required': False}), 5: ('wagtail.images.blocks.ImageChooserBlock', (), {'help_text': 'Image - auto-cropped 570x370px', 'required': False}), 6: ('wagtail.blocks.PageChooserBlock', (), {'label': 'Page link', 'required': False}), 7: ('wagtail.documents.blocks.DocumentChooserBlock', (), {'label': 'Document link', 'required': False}), 8: ('wagtail.blocks.CharBlock', (), {'label': 'Extra link', 'max_length': 255, 'required': False}), 9: ('wagtail.blocks.CharBlock', (), {'label': 'Title', 'max_length': 255, 'required': False}), 10: ('wagtail.blocks.StructBlock', [[('page_link', 6), ('doc_link', 7), ('extra_link', 8), ('button_title', 9)]], {'help_text': 'Enter a link or select a page/document', 'required': False}), 11: ('wagtail.blocks.StructBlock', [[('title', 3), ('text', 4), ('image', 5), ('link', 10)]], {}), 12: ('wagtail.blocks.ListBlock', (11,), {}), 13: ('wagtail.blocks.StructBlock', [[('cards', 12)]], {}), 14: ('wagtail.images.blocks.ImageChooserBlock', (), {'blank': True, 'null': True}), 15: ('wagtail.blocks.ChoiceBlock', [], {'choices': [('full', 'Full width centered'), ('left', 'Image to the left'), ('right', 'Image to the right')], 'help_text': 'Full image - text below, Image left - text right, or image right - text left.'}), 16: ('wagtail.blocks.ChoiceBlock', [], {'choices': [('standard', 'Standard 786x552'), ('landscape', 'Landscape 786x1104'), ('portrait', 'Portrait 786x300')], 'help_text': 'Layout - match with picture dimensions'}), 17: ('wagtail.blocks.CharBlock', (), {'blank': True, 'help_text': 'Max length of 60 characters.', 'max_length': 60, 'null': True, 'required': False}), 18: ('wagtail.blocks.RichTextBlock', (), {'blank': True, 'features': ['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'document-link', 'image', 'embed', 'code', 'blockquote', 'superscript', 'subscript', 'strikethrough'], 'help_text': 'Description for this item', 'required': False}), 19: ('wagtail.blocks.StructBlock', [[('page_link', 6), ('doc_link', 7), ('extra_link', 8), ('button_title', 9)]], {'blank': True, 'null': True, 'required': False}), 20: ('wagtail.blocks.StructBlock', [[('image', 14), ('image_alignment', 15), ('image_size', 16), ('title', 17), ('text', 18), ('link', 19)]], {}), 21: ('wagtail.blocks.CharBlock', (), {'blank': True, 'help_text': 'Max length of 60 characters, optional', 'max_length': 60, 'null': True, 'required': False}), 22: ('wagtail.blocks.RichTextBlock', (), {'blank': True, 'features': ['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'document-link', 'image', 'embed', 'code', 'blockquote', 'superscript', 'subscript', 'strikethrough'], 'help_text': 'Call to action text, optional (max=200)', 'required': False}), 23: ('wagtail.blocks.StructBlock', [[('title', 21), ('text', 22), ('link', 19)]], {}), 24: ('wagtail.blocks.CharBlock', (), {'blank': True, 'help_text': 'Display title, optional (max len=120)', 'max_length': 120, 'null': True, 'required': False}), 25: ('wagtail.blocks.RichTextBlock', (), {'features': ['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'document-link', 'image', 'embed', 'code', 'blockquote', 'superscript', 'subscript', 'strikethrough'], 'help_text': 'Rich text block, required'}), 26: ('wagtail.blocks.StructBlock', [[('title', 24), ('content', 25)]], {}), 27: ('wagtail.embeds.blocks.EmbedBlock', (), {}), 28: ('wagtail.blocks.StructBlock', [[('title', 21), ('video', 27), ('text', 22)]], {}), 29: ('cmspage.blocks.LargeImageBlock', (), {}), 30: ('cmspage.blocks.CustomTableBlock', (), {}), 31: ('wagtail.blocks.StructBlock', [[]], {}), 32: ('cmspage.blocks.NewSectionBlock', (), {})}, null=True)),
            ],
            options={
