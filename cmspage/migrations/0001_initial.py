    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("event_datetime", models.DateTimeField(db_index=True, verbose_name="Event Date Time")),
                ("event_duration", models.FloatField(default=1.0, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name="Event Duration (hours)")),
